...
<section id="container">
	...
	<div id="demo-container">
		...
		<div class="list-group">
			<button type="button" onclick="demo('demo1.do');" 
			class="list-group-item list-group-item-action">
				HttpRequest로 파라미터처리하기
			</button>
		</div>
		<div class="list-group">
			<button type="button" onclick="demo('demo2.do');" 
			class="list-group-item list-group-item-action">
				@RequestParam어노테이션이용 파라미터처리하기
			</button>
		</div>
		<div class="list-group">
			<button type="button" onclick="demo('demo3.do');" 
			class="list-group-item list-group-item-action">
				Command(Vo)객체 이용해서 파라미터처리하기
			</button>
		</div>
		<div class="list-group">
			<button type="button" onclick="demo('demo4.do');" 
			class="list-group-item list-group-item-action">
				Map객체 이용해서 파라미터처리하기
			</button>
		</div>
		<div class="list-group">
			<button type="button" onclick="demo('demo5.do');" 
			class="list-group-item list-group-item-action">
				추가데이터 가져오기(header,cookie)
			</button>
		</div>
		<div class="list-group">
			<button type="button" onclick="demo('insertDev.do');" 
			class="list-group-item list-group-item-action">
				Dev데이터 입력하기
			</button>
		</div>		
